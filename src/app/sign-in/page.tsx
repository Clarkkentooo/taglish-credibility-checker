    ...
    <main className="grid min-h-screen place-items-center px-4 py-10">
      <div className="grid w-full max-w-5xl gap-5 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
        ...
        <Card className="w-full max-w-md justify-self-center p-6 shadow-glow">
          ...
          <Button onClick={handleSignIn} variant="secondary" className="mt-6 w-full gap-2">
          ...
          <form onSubmit={handleSignIn} className="space-y-4" aria-describedby="auth-demo-note">
            ...
            <label className="block text-sm font-medium">
              Password
              <input type="password" autoComplete="current-password" required className="mt-2 min-h-11 w-full rounded-full border border-white/80 bg-white/65 px-4" placeholder="Any password" />
            </label>
            <Button type="submit" className="w-full">Continue to demo dashboard</Button>
          </form>
